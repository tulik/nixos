...
const ThemeToggle = () => {
    ...
    return (
        <button
            ...
            data-theme={theme}
        >
            <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/8 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="relative flex items-center gap-3">
                <div className="toggle-track h-6 w-12 rounded-full border border-border/70 bg-surface/80 flex items-center px-1 transition-all duration-500 ease-out">
                    <div
                        className={`toggle-thumb h-5 w-5 rounded-full bg-gradient-to-br from-brand-blue to-brand-accent text-white grid place-items-center shadow-md transition-all duration-500 ease-out ${isLight ? 'translate-x-0 rotate-0' : 'translate-x-5 rotate-12'
                            }`}
                    >
                        {isLight ? (
